    ...
    <div class="blocks-column">
      ...
      <div v-for="(block, blockIndex) in blocks" :key="block.id" :class="block.className" class="block" :style="block.styles" @click="selectBlock(blockIndex)">
        ...
        <div>
          ...
          <button @click="block.activeContent = 'inputs'">Inputy</button>
        ...
        <div>
          ...
          <!-- Edytowalny nagłówek -->
          <component :is="block.header.type" contenteditable @input="updateHeaderText($event, blockIndex)">
            {{ block.header.text }}
          </component>
        </div>
        <div v-if="block.activeContent === 'inputs'">
          <h3>Inputy</h3>
